...
public class AddressController {
    ...
    public ResponseEntity<Set<Address>> saveAddressHandler(@RequestBody Address address, @PathVariable String email) throws CustomerException {
        return new ResponseEntity<>(addressService.addAddress(address, email), HttpStatus.CREATED);
    }

    @PutMapping("/updateAddress/{email}")
    public ResponseEntity<Address> updateAddressHandler(@RequestBody Address address, @PathVariable String email) throws CustomerException, AddressException {
    ...
    public ResponseEntity<Address> deleteAddressHandler(@PathVariable Integer addressId, @PathVariable String email) throws CustomerException {
        return new ResponseEntity<>(addressService.deleteAddress(addressId, email), HttpStatus.CREATED);
    }

    @GetMapping("/addAddress/{email}")
    public ResponseEntity<Set<Address>> getAllAddressHandler(@PathVariable String email) throws CustomerException {
